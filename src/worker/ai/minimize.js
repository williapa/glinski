...
const minimize = (alpha, beta, board, capturedPieces, chatFirst, depth, enPassantPawnPosition, odd, isChatsMove) => {
  let move = null;
  ...
  for (const coords of moves) {
    ...
    const [evaluation] = maximize(alpha, beta, newBoard, newCapturedPieces, chatFirst, depth - 1, newEnPassantPosition, odd, isChatsMove);
